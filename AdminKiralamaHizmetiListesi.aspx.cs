...
public partial class AdminKiralamaHizmetiListesi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Repeater1.DataSource = dt.AdminKiralamaListesiGetir();
        //Repeater1.DataBind();
        ...
        SqlCommand komut = new SqlCommand("select HizmetDetayid, HizmetDetayAd,HizmetDetayYer,HizmetDetayResim,HizmetAdi,HizmetTuru from Tbl_HizmetDetay inner join Tbl_Hizmetler on Tbl_HizmetDetay.Hizmetid=Tbl_Hizmetler.Hizmetid inner join Tbl_HizmetTuru on Tbl_HizmetDetay.HizmetTuruid=Tbl_HizmetTuru.HizmetTuruid where HizmetTuru='Kiralama Hizmeti' order by  HizmetDetayid desc ", baglanti);
