<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminKiralamaHizmetiListesiDetay.aspx.cs" Inherits="AdminKiralamaHizmetiListesiDetay" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Kiralama Hizmet Ayrıntı </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
