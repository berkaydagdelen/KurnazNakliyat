<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="TasimacilikHizmetiEkle.aspx.cs" Inherits="TasimacilikHizmetiEkle" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Taşımacılık Hizmeti Oluştur </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
