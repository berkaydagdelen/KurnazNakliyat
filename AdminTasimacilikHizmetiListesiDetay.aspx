<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminTasimacilikHizmetiListesiDetay.aspx.cs" Inherits="AdminTasimacilikHizmetiListesiDetay" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Taşımacılık Hizmet Ayrıntı </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TxtYapilanYer" CssClass="form-control" runat="server"></asp:TextBox>
